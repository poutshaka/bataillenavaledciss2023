...
public abstract class Joueur {
	...
	public String getNom() {
	 ...
	 public void jouerAvec(Joueur j) {
		 ...
		 this.adversaire = j;
		 j.adversaire = this;
		 if (this.adversaire != null && this.adversaire.adversaire == this)
			 deroulementJeu(this, j);
		 else 
		        System.out.println("Impossible de jouer avec ce joueur. Le lien entre les joueurs n'a pas pu être établi.");
	 }
	 ...
	 /*ette méthode est invoquée sur le joueur attaquant à la fin d’un tour de jeu. c est la coordonnée à laquelle le tir a eu lieu et etat le résultat de l'attaque. etat ne peut être que TOUCHE, COULE, A_L_EAU, ou GAMEOVER.*/
